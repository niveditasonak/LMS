  ...
  $(document).ready(function() {
    $('#QuizTableContainer').jtable({
      ...
      actions : {
        ...
        createAction:'manageQuizesCreate',
        updateAction: 'manageQuizesUpdate',
        deleteAction: 'manageQuizesDelete'
      },
      fields : {
        ...
        ,quiz_title : {
              ...
              display: function (data) {
                  return '<a href="manageQuestions?quiz_id=' + data.record.quiz_id + '">' + data.record.quiz_title + '</a>';
              }
          },
          quiz_description : {
          title : 'Description',
                  ...
                  $img.click(function () {
                      $('#QuizTableContainer').jtable('openChildTable',
                              $img.closest('tr'),
                              {
                                  ...
                                  actions: {
                                      listAction: '/elmo/quizSubmissionList?quiz_id=' + studentData.record.quiz_id,
                                      updateAction: '/elmo/quizSubmissionUpdate?quiz_id=' + studentData.record.quiz_id
                                              },
                                  fields: {
                                      submission_id: {
