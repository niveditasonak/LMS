...
<script type="text/javascript">
  $(document).ready(function() {
    $('#AssignmentTableContainer').jtable({
      ...
      actions : {
        listAction : 'takeAssignmentsList',
      },
      fields : {
        ...
        assignment_title : {
          ...
          display: function (data) {
            return '<a href="openAssignment?id=' + data.record.assignment_id + '">' + data.record.assignment_title + '</a>';
          }
            ...
            $img.click(function () {
              $('#AssignmentTableContainer').jtable('openChildTable',
                      $img.closest('tr'),
                      {
                        ...
                        actions: {
                          listAction: '/elmo/assMySubmissionList?assignment_id=' + studentData.record.assignment_id,
                        },
                        fields: {
                          submission_id: {
