...
public class SubmitAssignmentController {
    ...
    @RequestMapping(value = "/elmo/openAssignment", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/elmo/openQuiz", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/elmo/submitAssignmentSubmit", method = RequestMethod.POST)
...
byte[] byteA  = null;
    ...
    @RequestMapping(value = "/elmo/submitQuizSubmit", method = RequestMethod.POST)
