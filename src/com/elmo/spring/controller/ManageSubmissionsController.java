...
public class ManageSubmissionsController {
    ...
    @RequestMapping(value = "/elmo/assSubmissionList", method = RequestMethod.POST)
    public
    @ResponseBody
    ...
    @RequestMapping(value = "/elmo/assSubmissionUpdate", method = RequestMethod.POST)
    public
    @ResponseBody
    ...
    @RequestMapping(value = "/elmo/assMySubmissionList", method = RequestMethod.POST)
    public
    @ResponseBody
    ...
    @RequestMapping(value = "/elmo/showSubmission", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/elmo/quizSubmissionList", method = RequestMethod.POST)
    public
    @ResponseBody
    ...
    @RequestMapping(value = "/elmo/quizSubmissionUpdate", method = RequestMethod.POST)
    public
    @ResponseBody
    ...
    @RequestMapping(value = "/elmo/quizMySubmissionList", method = RequestMethod.POST)
    public
    @ResponseBody
