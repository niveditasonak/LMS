...
public class ManageAssignmentsController {
    ...
    @RequestMapping(value = "/elmo/assignments", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/elmo/manageAssignments", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/elmo/manageAssignmentsList", method = RequestMethod.POST)
    public
    @ResponseBody
    ...
    @RequestMapping(value = "/elmo/takeAssignmentsList", method = RequestMethod.POST)
    public
    @ResponseBody
    ...
    @RequestMapping(value = "/elmo/manageAssignmentsUpdate", method = RequestMethod.POST)
    public
    @ResponseBody
...
//            }
    ...
    @RequestMapping(value = "/elmo/manageAssignmentsDelete", method = RequestMethod.POST)
    public
    @ResponseBody
    ...
    @RequestMapping(value = "/elmo/manageAssignmentsCreate", method = RequestMethod.POST)
    public
    @ResponseBody
